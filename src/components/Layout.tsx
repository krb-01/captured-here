  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      <header className="w-full text-white sticky top-0 z-50 p-4 bg-[#212121]">
        <Link href="/" className="block sm:inline-block sm:flex-col text-center sm:text-left">
          ...
          <div className="text-xs sm:text-sm sm:pl-1 tracking-widest whitespace-nowrap">Explore the World Through Photography Art Books</div>
        </Link>
      </header>
